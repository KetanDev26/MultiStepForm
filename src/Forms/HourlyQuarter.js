...
setValue(event.target.value);
    ...
    return(
        <div>
            ...
            <div class="form-group" style={{position:"absolute",top:150,left:900}}>
       ...
       {arr.map((l)=>(
           <option value={l}>{l}</option>
            ...
            <div class="form-group" style={{position:"absolute",top:150,left:1000}}>
  ...
  <RadioGroup aria-label="gender" name="gender1" value={value} onChange={handleChange}>
    ...
    <FormControlLabel style={{marginTop:-50,marginLeft:100}} value="Airport"  control={<Radio />} label="Airport" />
            ...
            <div>
                {value==="Airport" ? <div style={{position:"relative",marginTop:180,left:100}}>
                ...
                </div> :  <div style={{position:"relative",top:180,left:100}} >
